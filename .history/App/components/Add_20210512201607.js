...
const Add = () => {
  ...
  const expense = () => {
    return eflag ? Style.togglebtnOn : Style.togglebtnOff;
  };
  ...
  return (
    <SafeAreaView>
      ...
      <View style={Style.toggle}>
        <TouchableOpacity onPress={(() => setiflag(true), seteflag(false))}>
          <Text style={iflag ? Style.togglebtnOn : Style.togglebtnOff}>
            {" "}
            Income
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={(() => setiflag("0"), seteflag("1"))}>
          <Text style={eflag ? Style.togglebtnOn : Style.togglebtnOff}>
            {" "}
            Expense
          </Text>
        </TouchableOpacity>
